...
public class JwtService {
    ...
    public String generateToken(String username) {
        //For Generete the Jwt Token We have to add dependency - called- jjwt-api
        //Which will generate the token for Us

        // For implementing jwt ---> jjwt-imp
        //Also for verifying the token --->jjwt-jackson
